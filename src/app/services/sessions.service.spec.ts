...
describe('Service: SessionsService', () => {
  let service: SessionsService = null;
  ...
  beforeEach(inject([SessionsService, MockBackend], (sessionsService: SessionsService, mockBackend: MockBackend) => {
